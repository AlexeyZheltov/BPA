...
namespace BPA.Model
{
    ...
    class PlanningNewYearSave : TableBase
    {
        ...
        private readonly Dictionary<string, string> _filds = new Dictionary<string, string>
        {
            ...
            //{ "PromoGS01", "Промо GS январь, руб." },
            //{ "PromoGS02", "Промо GS февраль, руб." },
            //{ "PromoGS03", "Промо GS март, руб." },
            //{ "PromoGS04", "Промо GS апрель, руб." },
            //{ "PromoGS05", "Промо GS май, руб." },
            //{ "PromoGS06", "Промо GS июнь, руб." },
            //{ "PromoGS07", "Промо GS июль, руб." },
            //{ "PromoGS08", "Промо GS август, руб." },
            //{ "PromoGS09", "Промо GS сентябрь, руб." },
            //{ "PromoGS10", "Промо GS октябрь, руб." },
            //{ "PromoGS11", "Промо GS ноябрь, руб." },
            //{ "PromoGS12", "Промо GS декабрь, руб." },

            //{ "PromoNS01", "Промо NS январь, руб." },
            //{ "PromoNS02", "Промо NS февраль, руб." },
            //{ "PromoNS03", "Промо NS март, руб." },
            //{ "PromoNS04", "Промо NS апрель, руб." },
            //{ "PromoNS05", "Промо NS май, руб." },
            //{ "PromoNS06", "Промо NS июнь, руб." },
            //{ "PromoNS07", "Промо NS июль, руб." },
            //{ "PromoNS08", "Промо NS август, руб." },
            //{ "PromoNS09", "Промо NS сентябрь, руб." },
            //{ "PromoNS10", "Промо NS октябрь, руб." },
            //{ "PromoNS11", "Промо NS ноябрь, руб." },
            //{ "PromoNS12", "Промо NS декабрь, руб." },
            ...
            { "IRPEur", "?" },
            { "RRC", "РРЦ 2021, руб. с НДС" },
            { "IRPIndex", "?" },
            { "DIY", "DIY цена 2021, руб. с НДС" },
            { "Price2Net", "?" },
            { "Price3Net", "3net цена 2021, руб. расчетная" },
            { "PriceTransfer", "?" },
            ...
            { "GS01", "ИТОГО GS январь, шт." },
            { "GS02", "ИТОГО GS февраль, шт." },
            { "GS03", "ИТОГО GS март, шт." },
            { "GS04", "ИТОГО GS апрель, шт." },
            { "GS05", "ИТОГО GS май, шт." },
            { "GS06", "ИТОГО GS июнь, шт." },
            { "GS07", "ИТОГО GS июль, шт." },
            { "GS08", "ИТОГО GS август, шт." },
            { "GS09", "ИТОГО GS сентябрь, шт." },
            { "GS10", "ИТОГО GS октябрь, шт." },
            { "GS11", "ИТОГО GS ноябрь, шт." },
            { "GS12", "ИТОГО GS декабрь, шт." },

            { "NS01", "ИТОГО NS январь, шт." },
            { "NS02", "ИТОГО NS февраль, шт." },
            { "NS03", "ИТОГО NS март, шт." },
            { "NS04", "ИТОГО NS апрель, шт." },
            { "NS05", "ИТОГО NS май, шт." },
            { "NS06", "ИТОГО NS июнь, шт." },
            { "NS07", "ИТОГО NS июль, шт." },
            { "NS08", "ИТОГО NS август, шт." },
            { "NS09", "ИТОГО NS сентябрь, шт." },
            { "NS10", "ИТОГО NS октябрь, шт." },
            { "NS11", "ИТОГО NS ноябрь, шт." },
            { "NS12", "ИТОГО NS декабрь, шт." },
            ...
            { "GPValue01","ИТОГО GP value январь, руб." },
            { "GPValue02","ИТОГО GP value февраль, руб." },
            { "GPValue03","ИТОГО GP value март, руб." },
            { "GPValue04","ИТОГО GP value апрель, руб." },
            { "GPValue05","ИТОГО GP value май, руб." },
            { "GPValue06","ИТОГО GP value июнь, руб." },
            { "GPValue07","ИТОГО GP value июль, руб." },
            { "GPValue08","ИТОГО GP value август, руб." },
            { "GPValue09","ИТОГО GP value сентябрь, руб." },
            { "GPValue10","ИТОГО GP value октябрь, руб." },
            { "GPValue11","ИТОГО GP value ноябрь, руб." },
            { "GPValue12","ИТОГО GP value декабрь, руб." }
        };
        #endregion
