...
; -------------------------------------------------------------------------------------------------------------------------------------------------
#define AppName      "EuroReport"                                            ; Название приложения
#define AppVersion   "1.0.0.1"                                               ; Версия программы
#define AppPublisher "Micro-Solution LLC"
#define AppURL       "https://micro-solution.ru"
#define AppGUI       "bd5a16bf-9c3f-46ba-aa64-18efeab42d43"

#define ProjectPath  "C:\Users\zhelt\source\repos\EuroReport\"
#define SetupPath    ProjectPath + "Setup\"                        
#define AppIco       SetupPath + "icon-application.ico"                       ; Файл с иконкой

#define FilesPath    ProjectPath + "EuroReport\bin\Release\"                  ; Папка с файлами, которые необходимо упаковать
#define ReleasePath  SetupPath + "Release\"                                   ; Выходная папка

#define TypeAddIn    "Word"                                                   ; Word or Excel
